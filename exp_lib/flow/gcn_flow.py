...
from exp_lib.model.gcn import GCN
...
class GCNFlow():
    ...
    def run(self, x, data, device, checkpoint_embed_file, patience):
    ...
    def init_encoder(self, data, input_dim, out_dim, embed_dim, num_layers, with_feat, with_target, dropout=0.5):
        encoder = GCN(
            input_dim, out_dim, embed_dim, num_layers,  data.num_nodes, 
            with_feat=with_feat, with_target=with_target, p=dropout
        )
